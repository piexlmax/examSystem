...
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/createTestPaper', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/deleteTestPaper', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/updateTestPaper', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/findTestPaper', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/getTestPaperList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/uploadSvg', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/getTestPaperSvg', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/getTestPaperMould', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/uploadMould', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/removeTestPaperFile', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/findAndCreateTestPaperSvgNode', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/uploadTestPaperSvgNode', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/downloadTestPaperSvgNode', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/clearTestPaperSvgNode', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/publicTestPaper', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/testPaper/getActiveTestPaper', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/examinationRecord/createExaminationRecord', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '888', '/examinationRecord/deleteExaminationRecord', 'DELETE', '', '', '');
...
INSERT INTO `sys_apis` VALUES (48, '2020-05-16 21:36:31', '2020-05-16 21:36:31', NULL, NULL, '/testPaper/createTestPaper', '新增TestPaper', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (49, '2020-05-16 21:36:31', '2020-05-16 21:36:31', NULL, NULL, '/testPaper/deleteTestPaper', '删除TestPaper', 'testPaper', 'DELETE');
INSERT INTO `sys_apis` VALUES (50, '2020-05-16 21:36:31', '2020-05-16 21:36:31', NULL, NULL, '/testPaper/updateTestPaper', '更新TestPaper', 'testPaper', 'PUT');
INSERT INTO `sys_apis` VALUES (51, '2020-05-16 21:36:31', '2020-05-16 21:36:31', NULL, NULL, '/testPaper/findTestPaper', '根据ID获取TestPaper', 'testPaper', 'GET');
INSERT INTO `sys_apis` VALUES (52, '2020-05-16 21:36:31', '2020-05-16 21:36:31', NULL, NULL, '/testPaper/getTestPaperList', '获取TestPaper列表', 'testPaper', 'GET');
INSERT INTO `sys_apis` VALUES (53, '2020-05-16 22:29:18', '2020-05-16 22:29:18', NULL, NULL, '/testPaper/uploadSvg', '上传svg', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (54, '2020-05-16 23:10:40', '2020-05-16 23:11:46', NULL, NULL, '/testPaper/getTestPaperSvg', '获取svg', 'testPaper', 'GET');
INSERT INTO `sys_apis` VALUES (55, '2020-05-17 10:26:08', '2020-05-17 10:26:08', NULL, NULL, '/testPaper/getTestPaperMould', '下载模板', 'testPaper', 'GET');
INSERT INTO `sys_apis` VALUES (56, '2020-05-17 10:26:39', '2020-05-17 10:26:39', NULL, NULL, '/testPaper/uploadMould', '上传模板', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (57, '2020-05-17 11:38:32', '2020-05-17 11:38:32', NULL, NULL, '/testPaper/removeTestPaperFile', '删除文件', 'testPaper', 'DELETE');
INSERT INTO `sys_apis` VALUES (58, '2020-05-17 15:32:41', '2020-05-17 15:32:41', NULL, NULL, '/testPaper/findAndCreateTestPaperSvgNode', '创建或者获取右键节点', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (59, '2020-05-17 16:40:14', '2020-05-17 16:40:14', NULL, NULL, '/testPaper/uploadTestPaperSvgNode', '上传节点文件', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (60, '2020-05-17 17:31:41', '2020-05-17 17:31:41', NULL, NULL, '/testPaper/downloadTestPaperSvgNode', '获取节点文件', 'testPaper', 'POST');
INSERT INTO `sys_apis` VALUES (61, '2020-05-17 18:05:36', '2020-05-17 18:05:36', NULL, NULL, '/testPaper/clearTestPaperSvgNode', '删除svgnode相关文件', 'testPaper', 'DELETE');
INSERT INTO `sys_apis` VALUES (62, '2020-05-17 18:40:00', '2020-05-17 20:48:02', NULL, NULL, '/examinationRecord/createExaminationRecord', '新增ExaminationRecord', 'examinationRecord', 'POST');
INSERT INTO `sys_apis` VALUES (63, '2020-05-17 18:40:00', '2020-05-17 20:48:06', NULL, NULL, '/examinationRecord/deleteExaminationRecord', '删除ExaminationRecord', 'examinationRecord', 'DELETE');
INSERT INTO `sys_apis` VALUES (64, '2020-05-17 18:40:00', '2020-05-17 20:48:31', NULL, NULL, '/examinationRecord/updateExaminationRecord', '更新ExaminationRecord', 'examinationRecord', 'PUT');
INSERT INTO `sys_apis` VALUES (65, '2020-05-17 18:40:00', '2020-05-17 20:48:28', NULL, NULL, '/examinationRecord/findExaminationRecord', '根据ID获取ExaminationRecord', 'examinationRecord', 'GET');
...
INSERT INTO `sys_base_menus` VALUES (19, '2019-10-20 11:14:42', '2020-05-09 17:41:29', '2020-05-16 21:29:13', 0, 0, 'example', 'example', 0, 'view/example/index.vue', '示例文件', 's-management', '示例文件', 6, 0, 0);
INSERT INTO `sys_base_menus` VALUES (20, '2019-10-20 11:18:11', '2020-05-09 17:41:29', '2020-05-16 21:29:06', 0, 19, 'table', 'table', 0, 'view/example/table/table.vue', '表格示例', 's-order', '表格示例', 1, 0, 0);
INSERT INTO `sys_base_menus` VALUES (21, '2019-10-20 11:19:52', '2020-05-09 17:41:29', '2020-05-16 21:29:07', 0, 19, 'form', 'form', 0, 'view/example/form/form.vue', '表单示例', 'document', '表单示例', 2, 0, 0);
INSERT INTO `sys_base_menus` VALUES (22, '2019-10-20 11:22:19', '2020-05-09 17:41:29', '2020-05-16 21:29:08', 0, 19, 'rte', 'rte', 0, 'view/example/rte/rte.vue', '富文本编辑器', 'reading', '富文本编辑器', 3, 0, 0);
INSERT INTO `sys_base_menus` VALUES (23, '2019-10-20 11:23:39', '2020-05-09 17:41:29', '2020-05-16 21:29:09', 0, 19, 'excel', 'excel', 0, 'view/example/excel/excel.vue', 'excel导入导出', 's-marketing', 'excel导入导出', 4, 0, 0);
INSERT INTO `sys_base_menus` VALUES (26, '2019-10-20 11:27:02', '2020-05-09 17:41:29', '2020-05-16 21:29:10', 0, 19, 'upload', 'upload', 0, 'view/example/upload/upload.vue', '上传下载', 'upload', '上传下载', 5, 0, 0);
INSERT INTO `sys_base_menus` VALUES (33, '2020-02-17 16:20:47', '2020-05-09 17:41:29', '2020-05-16 21:29:11', 0, 19, 'breakpoint', 'breakpoint', 0, 'view/example/breakpoint/breakpoint.vue', '断点续传', 'upload', '断点续传', 6, 0, 0);
INSERT INTO `sys_base_menus` VALUES (34, '2020-02-24 19:48:37', '2020-05-09 17:41:29', '2020-05-16 21:29:11', 0, 19, 'customer', 'customer', 0, 'view/example/customer/customer.vue', '客户列表（资源示例）', 's-custom', '客户列表（资源示例）', 7, 0, 0);
...
INSERT INTO `sys_base_menus` VALUES (47, '2020-05-16 21:57:05', '2020-05-16 22:00:25', NULL, 0, 0, 'examiner', 'examiner', 0, 'view/examiner/index.vue', '考官', 'notebook-1', NULL, 6, 0, 0);
INSERT INTO `sys_base_menus` VALUES (48, '2020-05-16 22:01:23', '2020-05-16 23:05:34', NULL, 0, 47, 'testPaperList', 'testPaperList', 0, 'view/examiner/testPaper/testPaper.vue', '考题列表', 'tickets', NULL, 0, 0, 0);
...
-- ----------------------------
-- Table structure for test_paper_svg_nodes
-- ----------------------------
DROP TABLE IF EXISTS `test_paper_svg_nodes`;
CREATE TABLE `test_paper_svg_nodes`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  ...
  `test_paper_id` int(10) UNSIGNED NULL DEFAULT NULL,
  `flow` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `log` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `configuration` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `test_papers`  (
  ...
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  `test_paper_status` tinyint(1) NULL DEFAULT NULL,
  `test_paper_start_time` datetime(0) NULL DEFAULT NULL,
  `test_paper_end_time` datetime(0) NULL DEFAULT NULL,
  `test_paper_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `test_paper_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
